...
class TestBuildSkillsSystemPrompt:
    ...
    def test_builds_index_with_skills(self, monkeypatch, tmp_path):
        ...
        # Descriptions are no longer in the compact index (loaded on demand via skill_view)
    ...
    def test_deduplicates_skills(self, monkeypatch, tmp_path):
        ...
        result = build_skills_system_prompt()
        # "search" should appear only once (deduplicated)
        import re
        assert len(re.findall(r'\bsearch\b', result)) == 1
    ...
    def test_includes_matching_platform_skills(self, monkeypatch, tmp_path):
        ...
        # Descriptions are no longer in the compact index
